const validateApplication = async (body) => {
    ...
    try {
        ...
        totalPrice = price + parseFloat(shipping_cost);
        approvalAmountWithBuffer = approval_amount * 1.1;
    ...
    try {
        sopRecord = await sopService.getSopRecordFromDB(application.id);
